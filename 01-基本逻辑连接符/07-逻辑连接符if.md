...
thm if.def.1.ext(prop p0, prop p1, prop p2) {
  ...
  iff.righti(or(and(p0,p1),and(not(p0),p2)), if(p0,p1,p2))
  if.def.1(p0, p1, p2)
}
```
...
thm if.def.2.lemma1(prop p0, prop p1, prop p2) {
  ...
  imp.andimp.2(p0, p1, not(p0), p2)
  syl(and(p0,p1), and(imp(p0,p1),imp(not(p0),p2)), and(not(not(p0)),p1))
  imp.andimp.3(p0, p1, not(p0), p2)
  and.2andii.1(p0, p1, not(not(p0)), p1)
  id(p1)
  notnot.2(p0)
}
```
...
thm if.def.2.lemma2(prop p0, prop p1, prop p2) {
  ...
  mp(imp(and(imp(p0,p1),imp(not(p0),p2)),or(and(p0,p1),and(not(p0),p2))), or(p0,not(p0)))
  or.not(p0)
  com12i(or(p0,not(p0)), and(imp(p0,p1),imp(not(p0),p2)), or(and(p0,p1),and(not(p0),p2)))
  and.or.split(imp(p0,p1), imp(not(p0),p2), p0, not(p0), or(and(p0,p1),and(not(p0),p2)))
  a2i(p0, p1, or(and(p0,p1),and(not(p0),p2)))
  rw3(p0, p1, or(and(p0,p1),and(not(p0),p2)), and(p0,p1))
  and.intro(p0, p1)
  or.left(and(p0,p1), and(not(p0),p2))
  a2i(not(p0), p2, or(and(p0,p1),and(not(p0),p2)))
  rw3(not(p0), p2, or(and(p0,p1),and(not(p0),p2)), and(not(p0),p2))
  and.intro(not(p0), p2)
  or.right(and(not(p0),p2), and(p0,p1))
}
```
...
thm if.def.2.lemma3(prop p0, prop p1, prop p2) {
  ...
  iff.introii.1(or(and(p0,p1),and(not(p0),p2)), and(imp(p0,p1),imp(not(p0),p2)))
...
thm if.def.2(prop p0, prop p1, prop p2) {
  ...
  iff.righti(and(imp(p0,p1),imp(not(p0),p2)), if(p0,p1,p2))
...
thm if.def.3.lemma3(prop p0, prop p1, prop p2) {
  ...
  if.def.2.lemma3(p0, p1, p2)
  and.iffandii.1(imp(p0,p1), imp(p0,p1), imp(not(p0),p2), or(p0,p2))
  iff.id(imp(p0,p1))
  iff.or.def(p0, p2)
}
```
...
thm if.def.3(prop p0, prop p1, prop p2) {
  ...
  iff.righti(and(imp(p0,p1),or(p0,p2)), if(p0,p1,p2))
...
thm if.def.4.lemma3(prop p0, prop p1, prop p2) {
  ...
  if.def.3.lemma3(p0, p1, p2)
  and.iffandii.1(imp(p0,p1), or(not(p0),p1), or(p0,p2), or(p0,p2))
  iff.id(or(p0,p2))
  iff.syl(imp(p0,p1), or(not(p0),p1), imp(not(not(p0)),p1))
  iff.or.def(not(p0), p1)
  imp.iffimpii.3(p0, p1, not(not(p0)), p1)
  iff.id(p1)
  iff.notnot(p0)
}
```
...
thm if.def.4(prop p0, prop p1, prop p2) {
  ...
  iff.righti(and(or(not(p0),p1),or(p0,p2)), if(p0,p1,p2))
...
thm if.def.5.lemma(prop p0, prop p1, prop p2) {
  ...
  if.def.4.lemma3(p0, p1, p2)
  and.iffandii.1(or(not(p0),p1), or(not(p0),p1), or(p0,p2), imp(not(p0),p2))
  iff.id(or(not(p0),p1))
  iff.or.def(p0, p2)
}
```
...
thm if.def.5(prop p0, prop p1, prop p2) {
  ...
  iff.righti(and(or(not(p0),p1),imp(not(p0),p2)), if(p0,p1,p2))
...
thm if.def.6(prop p0, prop p1, prop p2) {
  ...
  iff.righti(or(and(p0,p1),not(imp(p2,p0))), if(p0,p1,p2))
...
thm if.def.7(prop p0, prop p1, prop p2) {
  ...
  iff.righti(imp(imp(p2,p0),and(p0,p1)), if(p0,p1,p2))
...
thm if.not(prop p0, prop p1, prop p2) {
  ...
  iff.lefti(if(p0,p1,p2), if(not(p0),p2,p1))
  iff.righti(if(not(p0),p2,p1), if(p0,p1,p2))
  ...
  and.iffandii.1(p0, not(not(p0)), p1, p1)
  iff.notnot(p0)
  iff.id(p1)
}
```
...
thm if.true(prop p0, prop p1, prop p2) {
  ...
  iff.leftid(p0, if(p0,p1,p2), p1)
  iff.rightid(p0, p1, if(p0,p1,p2))
  iff.comid(p0, p1, if(p0,p1,p2))
  iff.rw2(p0, if(p0,p1,p2), p1, and(imp(p0,p1),imp(not(p0),p2)))
  if.def.2(p0, p1, p2)
  iff.introiid.1(p0, and(imp(p0,p1),imp(not(p0),p2)), p1)
  com12i(p0, and(imp(p0,p1),imp(not(p0),p2)), p1)
  and.left(imp(p0,p1), imp(not(p0),p2))
  rw3(p0, p1, and(imp(p0,p1),imp(not(p0),p2)), and(not(not(p0)),p1))
  imp.andimp.3(p0, p1, not(p0), p2)
  syl(p0, imp(p1,and(not(not(p0)),p1)), not(not(p0)))
  and.intro(not(not(p0)), p1)
  notnot.2(p0)
}
```
...
thm if.false(prop p0, prop p1, prop p2) {
  ...
  iff.comid(not(p0), p2, if(p0,p1,p2))
  iff.leftid(not(p0), if(p0,p1,p2), p2)
  iff.rightid(not(p0), p2, if(p0,p1,p2))
...
thm if.id(prop p0, prop p1) {
  ...
  iff.comi(p1, if(p0,p1,p1))
  iff.lefti(if(p0,p1,p1), p1)
  iff.righti(p1, if(p0,p1,p1))
  mp(iff(if(p0,p1,p1),p1), or(p0,not(p0)))
  or.not(p0)
  or.casesii(p0, not(p0), iff(if(p0,p1,p1),p1))
  if.true(p0, p1, p1)
  if.false(p0, p1, p1)
}
```
...
thm if.cases(prop p0, prop p1, prop p2, prop p3) {
  ...
  mp(iff(p0,if(p1,p2,p3)), or(p1,not(p1)))
  or.not(p1)
  or.casesii(p1, not(p1), iff(p0,if(p1,p2,p3)))
